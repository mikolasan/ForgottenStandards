...
object LengthUnits {
    ...
    val lengthUnits = arrayOf(
            ImperialUnit("arshin", ImperialUnitName.ARSHIN, arshinRatio),
            ImperialUnit("inch", ImperialUnitName.INCH, inchRatio),
            ImperialUnit("vershok", ImperialUnitName.VERSHOK, mutableMapOf(
            ...
            ImperialUnit("palm", ImperialUnitName.PALM, mutableMapOf(
            ...
            ImperialUnit("span", ImperialUnitName.SPAN, mutableMapOf(
            ...
            ImperialUnit("ell", ImperialUnitName.ELL, mutableMapOf(
                    ImperialUnitName.ARSHIN to 3.0/2.0)), // 1 arshin = 3/2 ells
            ImperialUnit("step", ImperialUnitName.STEP, mutableMapOf(ImperialUnitName.ARSHIN to 1.0)),
            ImperialUnit("foot", ImperialUnitName.FOOT, mutableMapOf(
                    ImperialUnitName.SAZHEN to 7.0, // 1 sazhen = 7 feet
                    ImperialUnitName.ARSHIN to 7.0/3.0)), //// 1 arshin = 7/3 feet
            ImperialUnit("sazhen", ImperialUnitName.SAZHEN, mutableMapOf(
            ...
            ImperialUnit("point", ImperialUnitName.POINT, mutableMapOf(ImperialUnitName.INCH to 100.0)),
            ImperialUnit("line", ImperialUnitName.LINE, mutableMapOf(ImperialUnitName.INCH to 10.0)),

            ImperialUnit("verst", ImperialUnitName.VERST, mutableMapOf(
            ...
            ImperialUnit("mile", ImperialUnitName.MILE, mutableMapOf(
                    ImperialUnitName.VERST to 1.0/7.0, // 1 verst = 1/7 miles
                    ImperialUnitName.ARSHIN to 1.0/10500.0)),
            ImperialUnit("kilometer", ImperialUnitName.KILOMETER, kilometerRatio),
            ImperialUnit("meter", ImperialUnitName.METER, mutableMapOf(
                    ImperialUnitName.VERST to 1066.8, // 1 verst ≈ 1066.8 m
                    ImperialUnitName.CENTIMETER to 0.01)),
            ImperialUnit("decimeter", ImperialUnitName.DECIMETER, mutableMapOf(
                    ImperialUnitName.METER to 10.0,
                    ImperialUnitName.ARSHIN to 7.112)),
            ImperialUnit("centimeter", ImperialUnitName.CENTIMETER, centimeterRatio),
            ImperialUnit("millimeter", ImperialUnitName.MILLIMETER, millimeterRatio),
            ImperialUnit("micrometer", ImperialUnitName.MICROMETER, mutableMapOf(
